...
ncaaf = Sport.where(name: "College Football", abbreviation: "NCAAF").first_or_create
ncaab = Sport.where(name: "College Basketball", abbreviation: "NCAAB").first_or_create
...
hec.divisions.where(name: "Central").first_or_create
hec.divisions.where(name: "Pacific").first_or_create
...
bt = fbs.divisions.where(name: "Big 10 Conference", abbreviation: "Big 10").first_or_create
cusa = fbs.divisions.where(name: "Conference USA", abbreviation: "CUSA").first_or_create
fbs.divisions.where(name: "Independents", abbreviation: "Ind").first_or_create
...
d1.divisions.where(name: "Southwestern Atlantic Conference", abbreviation: "SWAC").first_or_create
