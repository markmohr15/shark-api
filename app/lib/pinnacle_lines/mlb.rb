class PinnacleLines::Mlb < PinnacleLines::Base
  ...
  def self.game_info game
    ...
    spread_line = lines.find {|l| l["matchupId"] == pin_game_id && l["isAlternate"] == false && l["type"] == "spread" && l["prices"][0]["points"].abs == 1.5}
    ml_line = lines.find {|l| l["matchupId"] == pin_game_id && l["isAlternate"] == false && l["type"] == "moneyline"}
    total_line = lines.find {|l| l["matchupId"] == pin_game_id && l["isAlternate"] == false && l["type"] == "total" && l["period"] == 0}
